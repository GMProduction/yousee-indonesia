                                ...
                                <div class="p-3">
                                     <div id="strategic-locations-container" class="row g-3">
                                        <div class="col-12 text-center py-4">
                                            <button id="btnLoadPlaces" class="btn btn-outline-primary rounded-pill px-4 py-2 fw-bold d-inline-flex align-items-center justify-content-center" onclick="loadGoogleMapsAPI()" style="border-width: 2px;">
                                                <span class="material-symbols-outlined align-middle me-2">share_location</span> 
                                                Tampilkan Tempat Strategis
                                            </button>
                                            <p class="text-muted small mt-3 mb-0">Klik tombol di atas untuk memuat data fasilitas di sekitar lokasi ini.</p>
                                        </div>
                                     </div>
                                </div>
                            </div>
...
@section('morejs')
    ...
    <!-- GOOGLE MAPS API (Lazy Load on Click) -->
    <script>
        let isGmapLoading = false;
        function loadGoogleMapsAPI() {
            ...
            if (typeof google === 'object' && typeof google.maps === 'object') {
                initStrategicLocations();
                return;
            }
            
            if(isGmapLoading) return;
            isGmapLoading = true;
