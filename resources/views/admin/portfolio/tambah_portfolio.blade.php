            ...
            <div class="menu">
                <form id="form" onsubmit="return saveForm()" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="p-judulportfolio" name="name" value="{{$data ? $data->name : ""}}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="p-keteranganportfolio" class="summernote" name="description">{{$data ? $data->description :""}}</textarea>
                    </div>
