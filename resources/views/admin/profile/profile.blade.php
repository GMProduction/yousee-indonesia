        ...
        <div class="menu-container">
            <form class="menu" id="form" onsubmit="return formSave()">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="p-alamatpusat" name="head_office_address" value="{{$data ? $data->head_office_address : ''}}"
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="p-telpkantor" name="head_office_phone"  value="{{$data ? $data->head_office_phone : ''}}"
                           placeholder="Nomor Telp. Kantor">
                    <label for="p-telpkantor" class="form-label">No. Telp Kantor Pusat</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="p-petapusat" name="head_office_location" value="{{$data ? $data->head_office_location : ''}}"
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="p-alamatsolo" name="address" value="{{$data ? $data->address : ''}}"
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="p-notelp" name="phone" placeholder="lokasi"  value="{{$data ? $data->phone : ''}}">
                    <label for="p-notelp" class="form-label">No Telp Kantor Solo</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="p-petasolo" name="location"   value="{{$data ? $data->location : ''}}"
                           placeholder='<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.508271932542!2d106.88216657576419!3d-6.196469660706733!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f5b4958505db%3A0x489cbcb4771909c!2sYousee%20Indonesia%20-%20Marketing%20Office%20%7C%7C%20Billboard%2C%20Baliho%2C%20Videotron%20Nasional%20Indonesia!5e0!3m2!1sen!2sid!4v1706332624474!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>'>
                    <label for="p-petasolo" class="form-label">Lokasi Kantor Solo</label>
                </div>

                <div class="form-floating mb-3">
                    <input type="email" class="form-control" id="p-email" name="email" placeholder="lokasi" value="{{$data ? $data->email : ''}}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="facebook" name="p-facebook" value="{{$data ? $data->facebook : ''}}"
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="instagram" name="p-instagram" value="{{$data ? $data->instagram : ''}}"
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="tiktok" name="p-tiktok" value="{{$data ? $data->tiktok : ''}}"
                                placeholder="tiktok">
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="whatsapp" name="p-whatsapp" value="{{$data ? $data->whatsapp : ''}}"
